...
from utils.prompts import get_bestie_system_prompt, get_conversation_starter_prompt, parse_expression_from_response, get_expression_config
...
The followup_question should be engaging and help you understand their preferences better!"""
        ...
        chat = LlmChat(
            ...
            system_message=system_message
        ).with_model("anthropic", "claude-sonnet-4-5-20250929")  # Use Sonnet model for shopping (Haiku not available)
...
async def create_subscription(user_id: str, subscription_data: SubscriptionCreate, request: Request):
    ...
    try:
        ...
        if origin:
            ...
            request_base_url = os.environ.get('APP_URL', 'https://mates-mobile-build-1.preview.emergentagent.com')
        ...
        cancel_url = f"{request_base_url}/subscription"
